...
| 层级 | 定义 | 示例 |
| :--- | :--- | :--- |
| 已确认事实 | 评分标准、任务书、老师书面要求 | "论文不少于5000字" |
| 高可信度 | 老师多次明确说过、多份作业反馈一致、高分案例稳定特征 | "老师反复强调图表必须规范" |
| 中可信度 | 课堂内容中强调、同学反馈较一致、成绩与某特征存在对应 | "上课演示时总用回归分析" |
| 低可信度 | 单个同学判断、对老师性格的猜测、单次分数异常 | "听说她不看附件" |
| 无法判断 | 没有任何证据 | - |
