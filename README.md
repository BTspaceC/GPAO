...
> **当前版本状态**: `V2.0.0-RC3.2` (Draft Release)
> 合并与发布以远程 CI 状态（Required Status Check）为准。本系统强制执行完全的事实证据等级基线。
...
- 本工具**不能**承诺特定分数或确保高分。
- 教师偏好推断依赖于积累的 `FACT/HIGH/MEDIUM/LOW/UNKNOWN` 五级证据质量，信息不足时严格禁止凭空推测。
